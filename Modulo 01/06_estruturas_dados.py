...
Os elementos de uma lista podem ser de diferentes tipos de dados e são encerrados entre colchetes [],
...
#Para acessar os elementos a partir do final da lista utilizando índices negativos. 
